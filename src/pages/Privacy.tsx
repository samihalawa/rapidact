  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <main className="mx-auto max-w-3xl px-4 py-16 sm:px-6">
        <h1 className="text-3xl font-extrabold tracking-tight text-[#16181d]">Privacy policy</h1>
        ...
        <div className="mt-8 space-y-6 text-[15px] leading-relaxed text-[#5c6370]">
          <section>
            <h2 className="text-lg font-bold text-[#16181d]">What we collect</h2>
            <p className="mt-2">
          ...
          <section>
            <h2 className="text-lg font-bold text-[#16181d]">What our products collect</h2>
            <p className="mt-2">
          ...
          <section>
            <h2 className="text-lg font-bold text-[#16181d]">What we never do</h2>
            <p className="mt-2">
          ...
          <section>
            <h2 className="text-lg font-bold text-[#16181d]">Your rights (GDPR)</h2>
            <p className="mt-2">
