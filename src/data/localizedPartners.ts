...
export const PARTNERS_COPY: Record<Lang, PartnersCopy> = {
  en: {
    ...
    body: "Use RapidAct as paid discovery for clients with public AI touchpoints or possible Article 50 transparency duties. We document the company position; your firm keeps the relationship and delivers the higher-value work that follows.",
    primary: "Discuss a client",
    ...
    formTitle: "Tell us about your firm—and the first client, if ready.",
    formBody:
      "We will reply personally and map the quickest first engagement. No portal, certification or programme onboarding.",
    name: "Your name",
    ...
    notesPlaceholder:
      "Tell us what you sell. If a client is ready, include the company, known AI systems and the questions you want answered.",
    submit: "Discuss the first engagement",
    submitting: "Sending…",
    error:
  ...
  es: {
    ...
    body: "Usa RapidAct como diagnóstico de pago para clientes con puntos de contacto públicos de IA o posibles obligaciones de transparencia del artículo 50. Nosotros documentamos la posición de la empresa; tu firma conserva la relación y presta el trabajo de mayor valor.",
    primary: "Hablar de un cliente",
    ...
    formTitle:
      "Cuéntanos sobre tu firma y, si ya está listo, el primer cliente.",
    formBody:
      "Responderemos personalmente con el primer encargo más rápido. Sin portal, certificación ni onboarding de programa.",
    name: "Tu nombre",
    ...
    notesPlaceholder:
      "Cuéntanos qué vendes. Si ya tienes un cliente, incluye la empresa, los sistemas de IA conocidos y las preguntas a resolver.",
    submit: "Hablar del primer encargo",
    submitting: "Enviando…",
    error:
  ...
  de: {
    ...
    body: "Nutzen Sie RapidAct als bezahlte Analyse für Kunden mit öffentlichen KI-Kontaktpunkten oder möglichen Transparenzpflichten nach Artikel 50. Wir dokumentieren die Unternehmensposition; Sie behalten die Kundenbeziehung und die höherwertige Folgearbeit.",
    primary: "Einen Kunden besprechen",
    ...
    formTitle:
      "Beschreiben Sie Ihr Unternehmen und, falls bereit, den ersten Kunden.",
    formBody:
      "Wir antworten persönlich mit dem schnellsten ersten Auftrag. Ohne Portal, Zertifizierung oder Programm-Onboarding.",
    name: "Ihr Name",
    ...
    notesPlaceholder:
      "Beschreiben Sie Ihr Angebot. Falls ein Kunde bereit ist, nennen Sie Unternehmen, bekannte KI-Systeme und die zu klärenden Fragen.",
    submit: "Ersten Auftrag besprechen",
  ...
  fr: {
    ...
    body: "Utilisez RapidAct comme diagnostic payant pour les clients ayant des points de contact IA publics ou de possibles obligations de transparence au titre de l’article 50. Nous documentons la position de l’entreprise ; votre cabinet garde la relation et réalise la mission à plus forte valeur.",
    primary: "Discuter d’un client",
    ...
    formTitle: "Présentez votre cabinet et, s’il est prêt, le premier client.",
    formBody:
      "Nous répondrons personnellement avec la première mission la plus rapide. Sans portail, certification ni onboarding de programme.",
    name: "Votre nom",
    ...
    notesPlaceholder:
      "Décrivez votre offre. Si un client est prêt, indiquez l’entreprise, les systèmes d’IA connus et les questions à résoudre.",
    submit: "Discuter de la première mission",
    submitting: "Envoi…",
    error:
  ...
  it: {
    ...
    body: "Usa RapidAct come analisi a pagamento per clienti con punti di contatto IA pubblici o possibili obblighi di trasparenza ai sensi dell’articolo 50. Noi documentiamo la posizione aziendale; il tuo studio conserva il rapporto e realizza il lavoro a maggior valore.",
    primary: "Parla di un cliente",
    ...
    formTitle: "Descrivi il tuo studio e, se è pronto, il primo cliente.",
    formBody:
      "Risponderemo personalmente con il primo incarico più rapido. Senza portale, certificazione o onboarding di programma.",
    name: "Il tuo nome",
    ...
    notesPlaceholder:
      "Descrivi cosa vendi. Se hai già un cliente, indica azienda, sistemi IA noti e domande da chiarire.",
    submit: "Parla del primo incarico",
    submitting: "Invio…",
    error:
